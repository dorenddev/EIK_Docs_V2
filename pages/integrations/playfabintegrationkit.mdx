...
Make sure your Artifact Settings are set up correctly in the EOS Integration Kit settings. You can find more information about this [here](/docs/integrations/eik#artifact-settings).
