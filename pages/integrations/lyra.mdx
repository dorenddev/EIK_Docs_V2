...
If you have purchased Lyra from the Unreal Engine Marketplace, you can download the merged version of Lyra and EIK from the [Betide Studio License Manager](https://app.betidestudio.com/). This version of Lyra includes the necessary changes to work with EIK out of the box.
