...
## EOS Integration Kit 4.6 Changelog

Release Date: 2024-11-23

### New Features:

- Add option to relogin for Connect Interface Methods
- Add Option to add /member settings while creating and updating lobby.
- Added some fixes from changes in the last 3 versions of Engine.
- Added option to build Anti-Cheat build for your packaged project. [Beta - Only tested by me a few times at the moment]

### Bug Fixes:

- Fixes crashes on Leaderboard on 5.5
- Fixes Chinese word issue on responses

### Deprecated:

- Removes the need for player id from Destroy EIK Node
